...
const ApplicationDetail: React.FC = () => {
    ...
    const fetchApplicationDetail = async () => {
      try {
        ...
        const response = await axios.get(
          `http://127.0.0.1:3000/read-apps?id=${id}`,
          {
            headers: {
  ...
  const handleDelete = async () => {
    if (window.confirm('Are you sure you want to delete this application?')) {
      try {
        await axios.delete(`http://127.0.0.1:3000/delete-app?id=${id}`);
  ...
  const handleUpdate = async () => {
    ...
    try {
      await axios.put(
        `http://127.0.0.1:3000/update-app?id=${id}`,
        editedApplication,
        {
          headers: {
            'Content-Type': 'application/json',
  ...
  // 在 ApplicationDetail 组件内部添加以下样式常量
  ...
  const cardClass = "bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-200";
                ...
                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                  <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white p-8">
                    <div className="flex justify-between items-center">
                      <div>
                        <h2 className="text-3xl font-bold mb-4">{application.personalDetails.name}</h2>
                          ...
                          {application.liabilities.map((liability) => (
                            <div key={liability._id} className={itemClass}>
                              <div className="flex justify-between items-center">
                                ...
                                <span className="font-semibold text-red-600">{formatCurrency(liability.amount)}</span>
                              </div>
                            </div>
                          ))}
                        </div>
                      ...
                      <div className="bg-gray-50 p-6 rounded-lg">
                        ...
                        <div className="space-y-4">
                          {editedApplication.income.map((income, index) => (
                            <div key={income._id} className="grid grid-cols-3 gap-4 p-4 bg-gray-50 rounded relative">
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    ...
                                    setEditedApplication({ ...editedApplication, income: newIncome });
                                  }}
                                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                />
                              </div>
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    const newIncome = [...editedApplication.income];
                                    newIncome[index] = { ...income, amount: parseFloat(e.target.value) };
                                    setEditedApplication({ ...editedApplication, income: newIncome });
                                  }}
                                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                />
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    const newIncome = [...editedApplication.income];
                                    newIncome[index] = { ...income, date: e.target.value };
                                    setEditedApplication({ ...editedApplication, income: newIncome });
                                  }}
                                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                />
                      ...
                      <div className="bg-gray-50 p-6 rounded-lg">
                        ...
                        <div className="space-y-4">
                          {editedApplication.expenses.map((expense, index) => (
                            <div key={expense._id} className="grid grid-cols-3 gap-4 p-4 bg-gray-50 rounded relative">
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    ...
                                    newExpenses[index] = { ...expense, description: e.target.value };
                                    setEditedApplication({ ...editedApplication, expenses: newExpenses });
                                  }}
                                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                />
                              </div>
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    const newExpenses = [...editedApplication.expenses];
                                    newExpenses[index] = { ...expense, amount: parseFloat(e.target.value) };
                                    setEditedApplication({ ...editedApplication, expenses: newExpenses });
                                  }}
                                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                />
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    const newExpenses = [...editedApplication.expenses];
                                    newExpenses[index] = { ...expense, date: e.target.value };
                                    setEditedApplication({ ...editedApplication, expenses: newExpenses });
                                  }}
                                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                />
                      ...
                      <div className="bg-gray-50 p-6 rounded-lg">
                        ...
                        <div className="space-y-4">
                          {editedApplication.assets.map((asset, index) => (
                            <div key={asset._id} className="grid grid-cols-2 gap-4 p-4 bg-gray-50 rounded relative">
                              <div>
                                <label className="block text-sm font-medium text-gray-700">Description</label>
                                <input
                                  type="text"
                                  ...
                                  onChange={(e) => {
                                    ...
                                    setEditedApplication({ ...editedApplication, assets: newAssets });
                                  }}
                                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                />
                              </div>
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    const newAssets = [...editedApplication.assets];
                                    newAssets[index] = { ...asset, value: parseFloat(e.target.value) };
                                    setEditedApplication({ ...editedApplication, assets: newAssets });
                                  }}
                                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                />
                      ...
                      <div className="bg-gray-50 p-6 rounded-lg">
                        ...
                        <div className="space-y-4">
                          {editedApplication.liabilities.map((liability, index) => (
                            <div key={liability._id} className="grid grid-cols-2 gap-4 p-4 bg-gray-50 rounded relative">
                              <div>
                                <label className="block text-sm font-medium text-gray-700">Description</label>
                                <input
                                  type="text"
                                  ...
                                  onChange={(e) => {
                                    ...
                                    newLiabilities[index] = { ...liability, description: e.target.value };
                                    setEditedApplication({ ...editedApplication, liabilities: newLiabilities });
                                  }}
                                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                />
                              </div>
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    const newLiabilities = [...editedApplication.liabilities];
                                    newLiabilities[index] = { ...liability, amount: parseFloat(e.target.value) };
                                    setEditedApplication({ ...editedApplication, liabilities: newLiabilities });
                                  }}
                                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                />
